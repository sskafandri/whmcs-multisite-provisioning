...
Plugin URI: https://github.com/rooneyj9005/whmcs-multisite-provisioning
Description: This plugin allows remote control of Multisite provisioning from WHMCS. Includes provisioning for Subdomain, Subdirectory or Domain Mapping Wordpress Multisite installs. This copy of the plugin is maintained abandonware, meaning the original authori has abandoned it, but the software is now maintained by the new maintainer (i.e. the Author of this plugin as it appears in WordPress.)
Author: John Rooney
Author Uri: https://github.com/rooneyj9005
Text Domain: mrp
